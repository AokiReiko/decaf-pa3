...
public abstract class Tree {
    ...
    public static final int CASEITEM = SWITCH + 1;

    /**
     * Case parts in switch statements, of type Case.
     */
    public static final int CASE = CASEITEM + 1;
    ...
    public static final int DOOD = RETURN + 1;
    
    /**
     * Do branch statements, of type Do.
     */
    public static final int DOODBRANCH = DOOD + 1;
    ...
    public static final int SUPER = PRINT + 1;
  ...
  public static class Scopy extends Expr {
   ...
   public static class Case extends Expr {
    ...
    public Expr defaultExpr;
     ...
     public Case(Expr condition, List<Tree> caseList, Expr defaultExpr,
      Location loc) {
       super(CASE, loc);
       this.condition = condition;
    ...
    public void printTo(IndentPrintWriter pw) {
      ...
      pw.incIndent();
           ...
           if (this.caseList != null)
            for (Tree caseitem: this.caseList) {
             caseitem.printTo(pw);
            }
      pw.println("default");
      pw.incIndent();
      this.defaultExpr.printTo(pw);
      pw.decIndent();
      pw.decIndent();
      pw.decIndent();
    }
  ...
  public Expr expr;
    public Type type;
     ...
     public CaseItem(Expr cond, Expr expr,
      Location loc) {
       super(CASEITEM, loc);
       this.cond = (Literal)cond;
    this.expr = expr;
     }
   ...
   public static class Dood extends Tree {
    ...
    public List<Tree> branches;
       public Dood(List<Tree> branches, Location loc) {
           super(DOOD, loc);
   ...
   /**
    * Do-od branch statement.
    */
   public static class DoodBranch extends Tree {
    
    public Expr expr;
    public Tree stmt;
      public DoodBranch(Expr expr, Tree stmt, Location loc) {
          super(DOODBRANCH, loc);
          this.expr = expr;
          this.stmt = stmt;
      }
    ...
    public static abstract class Visitor {
        ...
        public void visitDoodBranch(DoodBranch that) {
            visitTree(that);
        }
